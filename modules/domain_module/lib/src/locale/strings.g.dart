...
/// Strings: 4
///
/// Built on 2025-02-23 at 13:33 UTC
...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	late final _StringsNotificationTypeId notificationType = _StringsNotificationTypeId._(_root);
	late final _StringsPaymentMethodId paymentMethod = _StringsPaymentMethodId._(_root);
}

// Path: notificationType
class _StringsNotificationTypeId {
	_StringsNotificationTypeId._(this._root);
...
// Path: paymentMethod
class _StringsPaymentMethodId {
	_StringsPaymentMethodId._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get free => 'Gratis dari Paper+';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'paymentMethod.free': return 'Gratis dari Paper+';
			case 'paymentMethod.fee': return 'Biaya';
			default: return null;
		}
	}
}
